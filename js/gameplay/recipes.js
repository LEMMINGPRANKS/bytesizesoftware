...
export const RECIPES = [
  ...
  { out: [B.SWORD_WOOD,     1], in: [{ id: B.PLANKS, count: 2 },        { id: B.TWIG, count: 1 }], name: "Wood Sword (8 dmg)" },
  { out: [B.SWORD_STONE,    1], in: [{ id: B.COBBLE, count: 2 },        { id: B.TWIG, count: 1 }], name: "Stone Sword (10 dmg)" },
  { out: [B.SWORD_IRON,     1], in: [{ id: B.IRON_BLOCK, count: 1 },    { id: B.TWIG, count: 1 }], name: "Iron Sword (13 dmg)" },
  { out: [B.SWORD_DIAMOND,  1], in: [{ id: B.DIAMOND_BLOCK, count: 1 }, { id: B.TWIG, count: 1 }], name: "Diamond Sword (16 dmg)" },
  { out: [B.SWORD_PLATINUM, 1], in: [{ id: B.PLATINUM_BLOCK, count: 1 },{ id: B.TWIG, count: 1 }], name: "Platinum Sword (20 dmg — best weapon)" },
  { out: [B.AXE_WOOD,     1], in: [{ id: B.PLANKS, count: 3 },         { id: B.TWIG, count: 1 }], name: "Wood Axe (chops wood fast)" },
  { out: [B.AXE_STONE,    1], in: [{ id: B.COBBLE, count: 3 },         { id: B.TWIG, count: 1 }], name: "Stone Axe" },
  { out: [B.AXE_IRON,     1], in: [{ id: B.IRON_BLOCK, count: 1 },     { id: B.TWIG, count: 1 }], name: "Iron Axe" },
  { out: [B.AXE_DIAMOND,  1], in: [{ id: B.DIAMOND_BLOCK, count: 1 },  { id: B.TWIG, count: 1 }], name: "Diamond Axe" },
  { out: [B.AXE_PLATINUM, 1], in: [{ id: B.PLATINUM_BLOCK, count: 1 }, { id: B.TWIG, count: 1 }], name: "Platinum Axe (fastest chop)" },
